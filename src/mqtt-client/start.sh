...
STEPPER_PIN_1=${STEPPER_PIN_1:-17}
STEPPER_PIN_2=${STEPPER_PIN_2:-27}
STEPPER_PIN_3=${STEPPER_PIN_3:-22}
STEPPER_PIN_4=${STEPPER_PIN_4:-23}
HALL_SENSOR_PIN=${HALL_SENSOR_PIN:-18}
...
export BACKEND_URL
export DEVICE_TOKEN
export HARDWARE_ENABLED
export STEPPER_PIN_1
export STEPPER_PIN_2
export STEPPER_PIN_3
export STEPPER_PIN_4
export HALL_SENSOR_PIN
